			...
			while ($row2=mysqli_fetch_row($resultSecond))
			{
				if($row[0]=$row2[0]) {
					...
					echo "
						...
						<tr>
							<td align=center height=200pt id=\"WatchNewProducts_".$pid."\" onclick=\"WatchProduct(this.id);\">
							<hr>
							<span>".$pname."</span>
							<hr>
							<span>КОД: ".$pid."</span>
						...
						<tr>
							...
							<input id=\"InputNewProducts_".$pid."\" class=\"CountProductInput\" size=\"1\" type=\"number\" value=\"1\" min=\"1\" size=\"1\" align=\"left\" />
							</td>
							<td align=\"center\">
							<span id=\"SpanNewProducts_".$pid."\" class=\"SendToCartButton\" onclick=\"AddToCart(this.id);\">В корзину</span>
							</td>
							</tr></table>
